...
export default function Home() {
  ...
  return (
    <div id="ehlel" className="w-full h-[4400px] pt-0 bg-white">
      <div className="flex w-full h-20 p-4 fixed top-0 left-0 bg-white z-50 shadow">
        <img data-scroll-to="#ehlel"
          className="h-12 ml-64"
          src="https://www.toki.mn/wp-content/uploads/2022/08/Asset-1@3x.png"
          alt="Logo"
        />
        <button className="p-3 text-gray-900 ml-[500px]" data-scroll-to="#section1">Үйлчилгээ</button>
        <button data-scroll-to="#section2" className="p-3 text-gray-900">Давуу тал</button>
        <button data-scroll-to="#section3" className="p-3 text-gray-900">Мэдээ</button>
        <button data-scroll-to="#section4" className="p-3 text-gray-900">Хамтран ажиллах</button>
      </div>
      ...
      <div id="section1"  className="h-[800px]  flex items-center justify-center flex-row bg-white mt-20">
        <div className="ml-20 ">
          <img
            className="h-[700px]"
            src="/lab.jpeg"
      ...
      <div id="section3" className="h-[800px] pt- flex flex-row p-10 bg-white mt-20" >
      ...
      <div id="section2" className="h-[800px] flex flex-row p-10 bg-white mt-20">
        <div className="ml-52">
          <img
            className="h-[700px]"
            src="/labinOhin2.jpeg"
        ...
        <div id="section2" className="ml-10 w-[500px]   right-20 flex flex-col justify-start mt-60">
      ...
      <div className="ml-10 flex flex-col w-full right-20 pt-40 items-center justify-center">
        ...
        <div id="section4" className="bg-gray-900 h-[350px] flex justify-center items-center text-gray-400 " >
